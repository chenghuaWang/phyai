...
<ModelCard
  ...
  rows={{
    ...
    "运行入口": <code className="px-2 py-0.5 rounded bg-[#003399]/10 dark:bg-[#60A5FA]/15 text-[#003399] dark:text-[#60A5FA] text-xs font-mono">GR00TN17Scheduler</code>,
...
| `GR00TN17Scheduler` | 准备请求 tensor，将其分发给 backbone 和 action-head runner，并返回归一化 action chunk |
